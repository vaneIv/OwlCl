...
import com.vane.android.owlcl.databinding.FragmentLessonsSheetBinding
import com.vane.android.owlcl.model.Course
import com.vane.android.owlcl.model.lessons
import com.vane.android.owlcl.util.doOnApplyWindowInsets
import com.vane.android.owlcl.util.lerp
import com.vane.android.owlcl.util.lerpArgb
...
class LessonsSheetFragment : Fragment() {
    ...
    private val onClick: (Int) -> Unit = { step ->
        ...
        if (course != null) {
            ...
            BottomSheetBehavior.from(binding.lessonsSheet).state = BottomSheetBehavior.STATE_COLLAPSED
        }
    }
        ...
        binding = FragmentLessonsSheetBinding.inflate(inflater, container, false).apply {
            ...
            lessonsSheet.doOnLayout {
                ...
                lessonsSheet.doOnApplyWindowInsets { _, insets, _, _ ->
                    behavior.peekHeight = peek + insets.getInsets(WindowInsetsCompat.Type.navigationBars()).bottom
                }
            }
